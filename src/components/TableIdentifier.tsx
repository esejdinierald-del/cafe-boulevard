...
export const TableIdentifier = ({ language, tableNumber, isGeneric, onUpdate }: TableIdentifierProps) => {
  ...
  return (
    <div className="w-full max-w-xs mx-auto space-y-2">
      ...
      <div className="flex items-center gap-2 glass-gold rounded-full border-2 border-secondary/40 shadow-[var(--shadow-gold)] px-4 py-2 animate-[pulse_1.2s_ease-in-out_infinite] ring-2 ring-secondary/50 ring-offset-2 ring-offset-transparent">
